...
export type CustomerProfile={phone:string;ordersCount:number;totalSpend:number;averageCheck:number;firstOrderDate:string;lastOrderDate:string;recencyDays:number;channels:string[];rScore:number;fScore:number;mScore:number;rfmScore:string;segment:string};
